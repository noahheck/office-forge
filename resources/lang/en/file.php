...
return [
    ...
    'form_teamAccessApprovalDescription' => 'This form will only be accessible to members of these teams. If no teams are selected, this form will not be accessible by any of your staff.',
    'form_teamAccessApprovalShortDescription' => 'This form is only accessible to members of these teams.',
