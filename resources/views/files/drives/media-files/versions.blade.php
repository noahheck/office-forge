...
@include("_component._location-bar", [
    'locationBar' => (new \App\Navigation\LocationBar\Files\Drives\MediaFiles\Versions($file, $fileType, $drive, $mediaFile)),
])
...
@section('resource-content')
    ...
    <div class="card shadow document media-file--versions">
        <div class="card-body">
